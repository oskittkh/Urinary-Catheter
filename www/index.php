<?php
  ...
  $sql = "SELECT acc_code, hnno, fullname FROM tblaccount";
        ...
        <div class="app-content">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card mb-4">
                  <div class="card-header"><h2 class="card-title">Patient history</h3></div>
                  <!-- /.card-header -->
                          ...
                          <?php if ($result->num_rows > 0): ?>
                              <?php while ($row = $result->fetch_assoc()): ?>
                                  <tr class="align-middle">
                                      <!-- คอลัมภ์ที่ 1: running number -->
                                      <td><?= $no++; ?></td>

                                      <!-- คอลัมภ์ที่ 2: hnno -->
                                      <td><?= htmlspecialchars($row['hnno']); ?></td>

                                      <!-- คอลัมภ์ที่ 3: fullname -->
                                      <td><?= htmlspecialchars($row['fullname']); ?></td>

                                      <!-- คอลัมภ์ที่ 4: ปุ่ม Result -->
                                      <td>
                                          <a 
                                            href="./analytic.php?acc_code=<?= urlencode($row['acc_code']); ?>"
                                            class="btn btn-warning mb-2">Results
                                          </a>
                                      </td>
                                  </tr>
                              <?php endwhile; ?>
